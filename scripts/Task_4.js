...
const subscriptionPrice = 108000;
const chargePrice = 12000;

//calculations are here//
function selected () {
  document . getElementById() . month-selector = "month-selected","checked";
}

function multipliedBy2 () {
  var newBookPrice = bookPrice * 2 ;
  var newSubscriptionPrice = subscriptionPrice * 2 ;
  var newChargePrice = chargePrice * 2 ;
...
/* __________________________________Remember your past________________________________________
